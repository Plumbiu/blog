...
export function KeyboardEscIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
  ...
  return (
    <svg viewBox="0 0 24 24" {...props}>
      <path
        ...
        strokeLinejoin="round"
        strokeWidth="1.5"
        d="M19 11.5a7.5 7.5 0 1 1-15 0a7.5 7.5 0 0 1 15 0m-2.107 5.42l3.08 3.08M21 3L3 21"
      />
    </svg>
  )
}
...
export function CommandKey(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" {...props}>
      {/* Icon from Material Symbols by Google - https://github.com/google/material-design-icons/blob/master/LICENSE */}
      <path
