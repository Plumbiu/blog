...
// LICENSE: https://github.com/dderevjanik/vscode-icons-js/blob/master/LICENSE
...
export const FileNameIconMap: { [key: string]: string } = {
  ...
  'pnpm-lock.yaml': 'light_pnpm',
  'pnpm-workspace.yaml': 'light_pnpm',
  ...
  'rust-toolchain': 'light_rust_toolchain',
  '.sailsrc': 'sails',
  '.sentryclirc': 'sentry',
