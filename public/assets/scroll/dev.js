...
const getDomTokensArray = (t) =>
  deduplicateArray((isArray(t) ? t : (t || '').split(' ')).filter((t) => t))
  ...
  t &&
    ...
    each(n, (n, o) => {
      try {
        const s = t.style
        const e =
          isNull(n) || isBoolean(n) ? '' : isNumber(n) ? numberToCssPx(n) : n
        if (o.indexOf('--') === 0) {
          s.setProperty(o, e)
        } else {
          s[o] = e
  ...
  [Et]: {
    static: () => (t, n, o, s) => {
      ...
      const linearPressAnimation = (o, s) =>
        animateNumber(o, n - _, r * s, (o, s, e) => {
          t(o)
          if (e) {
            c = easedEndPressAnimation(o, n)
          }
        })
      const f = animateNumber(
        0,
        _,
        l,
        (r, l, a) => {
            ...
            if (!e) {
              ...
              s &&
                i(() => {
                  ...
                  c = e
                    ? linearPressAnimation(r, Math.abs(s) / o)
                    : easedEndPressAnimation(r, n)
                })
            }
          }
        },
...
const createSizeObserver = (t, n, o) => {
  ...
  return () => {
    ...
    if (f) {
      ...
      push(
        o,
        concat([addClass(l, ot), addEventListener(l, 'animationstart', t)], n),
      )
    } else {
      return noop
    }
...
const createObserversSetup = (t, n, o, s) => {
  ...
  const A =
    !w &&
    createSizeObserver(v, onSizeChanged, {
      dt: true,
    })
...
const createScrollbarsSetupElements = (t, n, o, s) => {
  ...
  const initScrollTimeline = (t) => {
    if (p) {
      ...
      const _setScrollPercentAnimation = (c) => {
        ...
        const i = t === 'x'
        const a = [
          getTrasformTranslateValue(0, i),
          getTrasformTranslateValue(`calc(100cq${i ? 'w' : 'h'} + -100%)`, i),
        ]
  ...
  const generateScrollbarDOM = (t) => {
    ...
    push(y, [
      ...
      i && i.Rt(l),
      s(l, scrollbarsAddRemoveClass, t),
    ])
    return l
  }
...
const createScrollbarsSetupEvents = (t, n, o, s) => (r, l, i) => {
    ...
    return addEventListener(g, 'pointerdown', (o) => {
      ...
      if (x) {
        ...
        const k = [
          ...
          addEventListener(g, n, releasePointerCapture),
          M && addEventListener(g, 'pointermove', (t) => $(D + (t[s] - C))),
          M &&
            (() => {
  ...
  return bind(runEachAndClear, [
    ...
    addEventListener(h, 'pointerenter', () => {
      l(gt, true)
    }),
    ...
    addEventListener(
      h,
      'pointerdown',
      bind(addEventListener, p, 'click', stopAndPrevent, {
        A: true,
        I: true,
        H: false,
      }),
...
const createStructureSetupElements = (t) => {
  ...
  const elementHasOverflow = (t) => {
    ...
    return (
      (o.w - n.w > 0 && !overflowIsVisible(s)) ||
      (o.h - n.h > 0 && !overflowIsVisible(e))
    )
  }
  const x = $(f)
  const H = x === v
...
const createOverflowUpdateSegment = (t, s) => {
  ...
  const setViewportOverflowStyle = (t) => {
    const createAllOverflowStyleClassNames = (t) =>
      [x, H, E].map((n) => createViewportOverflowStyleClassName(n, t))
    const n = createAllOverflowStyleClassNames(true)
  ...
  return ({ It: n, Zt: o, _n: i, Dt: a }, { fn: u }) => {
    ...
    const _t =
      (X && Y && (at.x || at.y)) || (X && at.x && !at.y) || (Y && at.y && !at.x)
